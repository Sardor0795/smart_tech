      ...
      <div className="container">
        <div className="col-9 col-md-12">
          ...
          <p>
            ...
            средства, ответить на все возможные вопросы и научить{" "}
            <a href="http">+7 (812) 509-23-43</a> кататься на выбранной вами
            модели
          </p>

          <h4>
            Мы всегда рады взаимовыгодному сотрудничеству. Свои предложения
            отправляйте <a href="http">smartfamily.info@yandex.ru</a>
          </h4>
        </div>
      </div>
    </>
