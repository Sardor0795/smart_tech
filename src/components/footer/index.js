      ...
      <div className="container">
        <div className="row">
          <div className="col-3 col-md-6 mb-6 col-sm-12">
            <img alt="img" src={logo} className="footer__logo" />
            <a href="http" className="footer__phone">
              +7 (958) 111-95-03
            </a>
            <a href="http" className="footer__phone">
              +7 (812) 660-50-54
          ...
          <div className="col-3 col-md-6 mb-6 col-sm-12">
            ...
            <ul className="footer__menu">
              ...
              <li>
                <NavLink to="/">Вопросы и ответы (F.A.Q.)</NavLink>
              </li>
              <li>
        ...
        <div className="footer__bottom">
          <div className="footer__copy">
            ...
            <a href="hppt" className="footer__author show-mobile">
              Разработка: websl.ru
            </a>
          </div>
          ...
          <a href="hppt" className="footer__author hide-mobile">
            Разработка: websl.ru
          </a>
        </div>
      </div>
